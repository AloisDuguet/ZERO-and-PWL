...
filename = "../IPG-and-PWL/SGM_files/instance_8_7_10_Abs2-5e-5_fixedcosttrue"
...
# to count time spent to solve best response with SCIP:
file = open("SCIP_time.txt", "a")
file.write("\n{}-{}:".format(game_type, filename[34:42]))
file.close()
