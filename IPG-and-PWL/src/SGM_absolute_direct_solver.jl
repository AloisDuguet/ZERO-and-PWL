...
function SGM_PWL_absolute_direct_solver(filename_instance; fixed_costs = true, refinement_method = "sufficient_refinement",
    ...
    if refinement_method != "full_refinement"
        ...
        if !PWL_general_constraint || refinement_method != "sufficient_refinement"
            ...
            options = option_cs_instance(filename_instance, err_pwlh, fixed_costs, refinement_method*"PWLgen", 1, rel_gap, abs_gap, NL_term, big_weights_on_NL_part, PWL_general_constraint)
        end
                        ...
                        for abs_gap in abs_gaps
                            if refinement_method != "full_refinement"
                                ...
                                for NL_term in NL_terms
                                    if NL_term == "S+inverse_square_root" # due to nonconvexity of the PWL approx, PWL_general_constraint must be set to false (gurobi does not know how to handle it)
                                        push!(instance_queue, option_cs_instance(filename_instance, err_pwlh, fixed_costs, refinement_method, max_iter, rel_gap, abs_gap, NL_term, big_weights_on_NL_part, false))
                                    else
...
filenames = ["revision_exps/abs_gap_1e-2/log234.txt","revision_exps/abs_gap_1e-3/log234.txt","revision_exps/abs_gap_1e-4/log234.txt"]
...
filenames = ["revision_exps/abs_gap_1e-2/root234.txt","revision_exps/abs_gap_1e-3/root234.txt","revision_exps/abs_gap_1e-4/root234.txt"]
for filename_save in filenames
    filename_analysis = filename_save[1:end-4]*"_analysis.txt"
    filename_statistics = filename_save[1:end-4]*"_statistics.txt"
...
filenames = ["revision_exps/abs_gap_1e-2/nonconvex234.txt","revision_exps/abs_gap_1e-3/nonconvex234.txt","revision_exps/abs_gap_1e-4/nonconvex234.txt"]
for filename_save in filenames
    filename_analysis = filename_save[1:end-4]*"_analysis.txt"
    filename_statistics = filename_save[1:end-4]*"_statistics.txt"
...
ilenames = ["revision_exps/abs_gap_1e-2/log567.txt","revision_exps/abs_gap_1e-3/log567.txt","revision_exps/abs_gap_1e-4/log567.txt"]
for filename_save in filenames
    filename_analysis = filename_save[1:end-4]*"_analysis.txt"
    filename_statistics = filename_save[1:end-4]*"_statistics.txt"
    refinement_methods = ["SGM_SOCP_model","sufficient_refinement","full_refinement"]
...
filenames = ["revision_exps/abs_gap_1e-2/root567.txt","revision_exps/abs_gap_1e-3/root567.txt","revision_exps/abs_gap_1e-4/root567.txt"]
for filename_save in filenames
    filename_analysis = filename_save[1:end-4]*"_analysis.txt"
    filename_statistics = filename_save[1:end-4]*"_statistics.txt"
    refinement_methods = ["SGM_gurobiNL_model","sufficient_refinement","full_refinement"]
...
filenames = ["revision_exps/abs_gap_1e-2/nonconvex567.txt","revision_exps/abs_gap_1e-3/nonconvex567.txt","revision_exps/abs_gap_1e-4/nonconvex567.txt"]
for filename_save in filenames
    filename_analysis = filename_save[1:end-4]*"_analysis.txt"
    filename_statistics = filename_save[1:end-4]*"_statistics.txt"
    refinement_methods = ["SGM_NL_model","sufficient_refinement","full_refinement"]
...
ilenames = ["revision_exps/abs_gap_1e-2/log8-15.txt","revision_exps/abs_gap_1e-3/log8-15.txt","revision_exps/abs_gap_1e-4/log8-15.txt"]
for filename_save in filenames
    filename_analysis = filename_save[1:end-4]*"_analysis.txt"
    filename_statistics = filename_save[1:end-4]*"_statistics.txt"
    refinement_methods = ["SGM_SOCP_model","sufficient_refinement","full_refinement"]
...
if false # just used to launch multiple terminal on the benchmarks
    ...
    benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances, refinement_methods = ["SGM_gurobiNL_model","sufficient_refinement","full_refinement"], abs_gaps = [0.01], err_pwlhs = [Absolute(0.05)], NL_terms = ["inverse_square_root"], filename_save = "test_exps/abs_gap_1e-2/root234.txt")
    benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances, refinement_methods = ["SGM_gurobiNL_model","sufficient_refinement","full_refinement"], abs_gaps = [0.001], err_pwlhs = [Absolute(0.05)], NL_terms = ["inverse_square_root"], filename_save = "test_exps/abs_gap_1e-3/root234.txt")
    benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances, refinement_methods = ["SGM_gurobiNL_model","sufficient_refinement","full_refinement"], abs_gaps = [0.0001], err_pwlhs = [Absolute(0.05)], NL_terms = ["inverse_square_root"], filename_save = "test_exps/abs_gap_1e-4/root234.txt")
    benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances, refinement_methods = ["SGM_NL_model","sufficient_refinement","full_refinement"], abs_gaps = [0.01], err_pwlhs = [Absolute(0.05)], NL_terms = ["S+inverse_square_root"], filename_save = "test_exps/abs_gap_1e-2/nonconvex234.txt")
    benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances, refinement_methods = ["SGM_NL_model","sufficient_refinement","full_refinement"], abs_gaps = [0.001], err_pwlhs = [Absolute(0.05)], NL_terms = ["S+inverse_square_root"], filename_save = "test_exps/abs_gap_1e-3/nonconvex234.txt")
    benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances, refinement_methods = ["SGM_NL_model","sufficient_refinement","full_refinement"], abs_gaps = [0.0001], err_pwlhs = [Absolute(0.05)], NL_terms = ["S+inverse_square_root"], filename_save = "test_exps/abs_gap_1e-4/nonconvex234.txt")

    benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances_big567_one_third, refinement_methods = ["SGM_SOCP_model","sufficient_refinement","full_refinement"], abs_gaps = [0.01], err_pwlhs = [Absolute(0.05)], filename_save = "test_exps/abs_gap_1e-2/log567.txt")
    benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances_big567_one_third, refinement_methods = ["SGM_SOCP_model","sufficient_refinement","full_refinement"], abs_gaps = [0.001], err_pwlhs = [Absolute(0.05)], filename_save = "test_exps/abs_gap_1e-3/log567.txt")
    benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances_big567_one_third, refinement_methods = ["SGM_SOCP_model","sufficient_refinement","full_refinement"], abs_gaps = [0.0001], err_pwlhs = [Absolute(0.05)], filename_save = "test_exps/abs_gap_1e-4/log567.txt")
    benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances_big567_one_third, refinement_methods = ["SGM_gurobiNL_model","sufficient_refinement","full_refinement"], abs_gaps = [0.01], err_pwlhs = [Absolute(0.05)], NL_terms = ["inverse_square_root"], filename_save = "test_exps/abs_gap_1e-2/root567.txt")
    benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances_big567_one_third, refinement_methods = ["SGM_gurobiNL_model","sufficient_refinement","full_refinement"], abs_gaps = [0.001], err_pwlhs = [Absolute(0.05)], NL_terms = ["inverse_square_root"], filename_save = "test_exps/abs_gap_1e-3/root567.txt")
    benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances_big567_one_third, refinement_methods = ["SGM_gurobiNL_model","sufficient_refinement","full_refinement"], abs_gaps = [0.0001], err_pwlhs = [Absolute(0.05)], NL_terms = ["inverse_square_root"], filename_save = "test_exps/abs_gap_1e-4/root567.txt")
    benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances_big567_one_third, refinement_methods = ["SGM_NL_model","sufficient_refinement","full_refinement"], abs_gaps = [0.01], err_pwlhs = [Absolute(0.05)], NL_terms = ["S+inverse_square_root"], filename_save = "test_exps/abs_gap_1e-2/nonconvex567.txt")
    benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances_big567_one_third, refinement_methods = ["SGM_NL_model","sufficient_refinement","full_refinement"], abs_gaps = [0.001], err_pwlhs = [Absolute(0.05)], NL_terms = ["S+inverse_square_root"], filename_save = "test_exps/abs_gap_1e-3/nonconvex567.txt")
    benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances_big567_one_third, refinement_methods = ["SGM_NL_model","sufficient_refinement","full_refinement"], abs_gaps = [0.0001], err_pwlhs = [Absolute(0.05)], NL_terms = ["S+inverse_square_root"], filename_save = "test_exps/abs_gap_1e-4/nonconvex567.txt")

    benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances_mega, refinement_methods = ["SGM_SOCP_model","sufficient_refinement","full_refinement"], abs_gaps = [0.01], err_pwlhs = [Absolute(0.05)], filename_save = "test_exps/abs_gap_1e-4/log8-15.txt")
    benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances_mega, refinement_methods = ["SGM_SOCP_model","sufficient_refinement","full_refinement"], abs_gaps = [0.001], err_pwlhs = [Absolute(0.05)], filename_save = "test_exps/abs_gap_1e-4/log8-15.txt")
    benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances_mega, refinement_methods = ["SGM_SOCP_model","sufficient_refinement","full_refinement"], abs_gaps = [0.0001], err_pwlhs = [Absolute(0.05)], filename_save = "test_exps/abs_gap_1e-4/log8-15.txt")
end
...
#benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances[[2,6,10]], refinement_methods = ["SGM_SOCP_model","sufficient_refinement","full_refinement"], err_pwlhs = [Absolute(0.05)], filename_save = "revision_exps/absolute_direct_log234.txt")
    

if false
    benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances, refinement_methods = ["SGM_SOCP_model","sufficient_refinement","full_refinement"], err_pwlhs = [Absolute(0.05)], filename_save = "revision_exps/absolute_direct_log234.txt")
    benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances_big567_complete, refinement_methods = ["SGM_SOCP_model","sufficient_refinement","full_refinement"], err_pwlhs = [Absolute(0.05)], filename_save = "revision_exps/absolute_direct_log567.txt")
    benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances, refinement_methods = ["SGM_gurobiNL_model","sufficient_refinement","full_refinement"], err_pwlhs = [Absolute(0.05)], NL_terms = ["inverse_square_root"], filename_save = "revision_exps/absolute_direct_root234.txt")
    benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances_big567_complete, refinement_methods = ["SGM_gurobiNL_model","sufficient_refinement","full_refinement"], err_pwlhs = [Absolute(0.05)], NL_terms = ["inverse_square_root"], filename_save = "revision_exps/absolute_direct_root567.txt")
    benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances, refinement_methods = ["SGM_NL_model","sufficient_refinement","full_refinement"], err_pwlhs = [Absolute(0.05)], NL_terms = ["S+inverse_square_root"], filename_save = "revision_exps/nonconvex234.txt", PWL_general_constraint = false)
    benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances_big567_complete, refinement_methods = ["SGM_NL_model","sufficient_refinement","full_refinement"], err_pwlhs = [Absolute(0.05)], NL_terms = ["S+inverse_square_root"], filename_save = "revision_exps/nonconvex567.txt", PWL_general_constraint = false)
end
