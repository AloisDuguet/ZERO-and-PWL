...
function launch_which_batch(number)
    ...
    if number == 1
        ...
        benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances_mega, refinement_methods = ["SGM_NL_model","sufficient_refinement","full_refinement"], abs_gaps = [0.01], err_pwlhs = [Absolute(0.05)], NL_terms = ["S+inverse_square_root"], filename_save = "revision_exps/abs_gap_1e-2/nonconvex8-15.txt")
        return 0
    end
    ...
    if number == 2
        ...
        benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances_mega[13:end], refinement_methods = ["SGM_gurobiNL_model","sufficient_refinement","full_refinement"], abs_gaps = [0.001], err_pwlhs = [Absolute(0.05)], NL_terms = ["inverse_square_root"], filename_save = "revision_exps/abs_gap_1e-3/root8-15.txt")
    ...
    if number == 3
        ...
        benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances_mega[12:end], refinement_methods = ["SGM_NL_model","sufficient_refinement","full_refinement"], abs_gaps = [0.0001], err_pwlhs = [Absolute(0.05)], NL_terms = ["S+inverse_square_root"], filename_save = "revision_exps/abs_gap_1e-4/nonconvex8-15.txt")
        benchmark_SGM_absolute_direct_solver(filename_instances = filename_instances_mega, refinement_methods = ["SGM_NL_model","sufficient_refinement","full_refinement"], abs_gaps = [0.001], err_pwlhs = [Absolute(0.05)], NL_terms = ["S+inverse_square_root"], filename_save = "revision_exps/abs_gap_1e-3/nonconvex8-15.txt")
        return 0
    end
