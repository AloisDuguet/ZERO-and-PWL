...
int main(int argc, char *argv[]) {
  ...
  try {
     ...
     cout << "filename_instance : " << filename_instance << endl;
    ...
    // Objective terms
     ...
     cout << "size of VarBounds2 is " << VarBounds2.size() << endl;
     ...
     IPG_Model.setGameObjective(Data::IPG::Objectives::Linear);
     ...
     // Launch the optimization with MIP if PATH did not find the solution
